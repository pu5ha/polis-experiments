...
export const config: ConversationConfig = createConfig({
  ...
  description: "EIP-8363 proposes tapering ETH issuance to zero and burning validator rewards once staking passes 50% of ETH's supply — the Ethereum community doesn't agree on whether that's a good idea.",
  ...
  polisConversationId: "9xjdymbbhw",
